...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference("Feedback.count") do
      post feedbacks_url, params: { feedback: { abbr: @feedback.abbr, order: @feedback.order, value: @feedback.value } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { abbr: @feedback.abbr, order: @feedback.order, value: @feedback.value } }
