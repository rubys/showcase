...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference("Recording.count") do
      post recordings_url, params: { recording: { heat_id: @recording.heat_id, judge_id: @recording.judge_id } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { heat_id: @recording.heat_id, judge_id: @recording.judge_id } }
